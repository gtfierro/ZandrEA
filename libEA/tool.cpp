...
// Point objects
   ...
   u_Qas =           std::make_unique<CPointAnalog>(   seq0Ref,
                                                      *u_Subject,
                                                      ...
                                                      EDataUnit::FlowVolume_Lps,
                                                      EDataRange::Analog_zeroTo1416,
                                                      EPlotGroup::Free,
...
// Formula objects
   ...
   u_absDifTaoTar =  std::make_unique<CFormula>(   seq0Ref,
                                                   *u_Subject,
                                                   ...
                                                   EDataUnit::TemperatureDiff_Cdeg,
                                                   EDataRange::Analog_n18To49,
                                                   EDataSuffix::None,
...
// float halfband = (+/-),  float warn = (units-of-x)-minutes over a reset
   ...
   u_Qas_VS_auto = std::make_unique<CChartTracking>(  seq0Ref,
                                                      *u_Subject,
                                                      u_Qas.get(),
                                                      u_QasShew.get(),
                                                      INIT_MINDEFMAX_TRACKING_HALFBAND_LPS_0TO1416,
                                                      INIT_MINDEFMAX_TRACKING_WARN_LPS_0TO1416,
                                                      ctrlrRef );
   ...
   u_PsasZero = std::make_unique<   CFactRelatingLeftToParam<
                                 ...
                                 >( seq0Ref,
                                    *u_Subject,
                                    ...
                                    &CRainAnalog::NowY,
                                    FIXED_PARAM_ZERO,
                                    INIT_MINDEFMAX_RELATE_HYSTER_PA_0TO1K,
                                    INIT_MINDEFMAX_RELATE_SLACK_PA_0TO1K,
                                    ctrlrRef );
   ...
   u_QasZero = std::make_unique< CFactRelatingLeftToParam<
                                 ...
                                 >( seq0Ref,
                                    *u_Subject,
                                    ...
                                    &CRainAnalog::NowY,
                                    FIXED_PARAM_ZERO,
                                    INIT_MINDEFMAX_RELATE_HYSTER_LPS_0TO1416,
                                    INIT_MINDEFMAX_RELATE_SLACK_LPS_0TO1416,
                                    ctrlrRef );
   ...
   u_Tam_GT_frzStat = std::make_unique<   CFactRelatingLeftToParam<
                                          ...
                                          >( seq0Ref,
                                             *u_Subject,
                                             ...
                                             u_Tam.get(),
                                             &CRainAnalog::NowY,
                                             INIT_HVACPARAM_AHU_FRZSTAT_DEGC,
                                             INIT_MINDEFMAX_RELATE_HYSTER_DEGC_n18TO49,
                                             INIT_MINDEFMAX_RELATE_SLACK_DEGC_n18TO49_EASY,
                                             ctrlrRef );
...
// Instantiate GUI Features
   ...
   u_GuiFeat02 = std::make_unique<CFeatureFact>(  *u_Subject,
                                                   ...
                                                   2,
                                                   *u_inputSteadySus,
                                                   ([&]()->bool { return u_inputSteadySus->Now(); }) );
   ...
   u_Tad_GT_Tai = std::make_unique< CFactRelatingLeftToRight<
                                       ...
                                       >( seq0Ref,
                                          *u_Subject,
                                          ...
                                          &CRainAnalog::NowY,
                                          INIT_MINDEFMAX_RELATE_HYSTER_DEGC_n18TO49,
                                          INIT_MINDEFMAX_RELATE_SLACK_DEGC_n18TO49_HARD,
                                          ctrlrRef );
